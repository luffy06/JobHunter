					  ...
					  <!-- Wrapper for slides -->
					  	<div class="carousel-inner" role="listbox">
						    <div class="item active">
							    <img src="public/img/ad/ad1.png" alt="...">
							    <div class="carousel-caption">
							     	图片描述
							    </div>
						    </div>
						    <div class="item">
						      	<img src="public/img/ad/ad2.png" alt="...">
						      	<div class="carousel-caption">
						        	图片描述
						      	</div>
					    	</div>
					    	<div class="item">
						      	<img src="public/img/ad/ad3.png" alt="...">
						      	<div class="carousel-caption">
						        	图片描述
						      	</div>
					    	</div>
			...
			<c:choose>
				<c:when test="${! empty jobtypelist}">
					<c:forEach var="jtl" items="${jobtypelist}" varStatus="st" step="4">
						<div class="row">
							<c:forEach var="y" begin="${st.index}" step="1" end="${fl:min(st.index + 4, fn:length(jobtpelist))}">
								<div class="col-md-4">
									<div class="btn-group">
